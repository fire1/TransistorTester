...
const uint16_t LogTab[] PROGMEM = {0, 20, 41, 62, 83, 105, 128, 151, 174, 198, 223, 248, 274, 301, 329, 357, 386, 416,
                                   446, 478, 511, 545, 580, 616, 654, 693, 734, 777, 821, 868, 916, 968, 1022, 1079,
                                   1139, 1204, 1273, 1347, 1427, 1514, 1609, 1715, 1833, 1966, 2120, 2303, 2526};
#endif
...
void loop() {
    ...
    WithReference = 1;        //  precision reference voltage
    ...
    if (PartFound == PART_DIODE) {
        ...
        if (NumOfDiodes > 2) {    // Transistor with protection diode
          ...
          if(PartMode == PART_MODE_NPN)
            ...
            if (((PartMode == PART_MODE_NPN) && (trans.c > trans.e)) ||
...
#define MAX_ENTLADE_ZEIT  (10000/20)
    ...
    for (lop_cnt = 0; lop_cnt < 10; lop_cnt++) {
        ...
        for (clr_cnt = 0; clr_cnt < MAX_ENTLADE_ZEIT; clr_cnt++) {
            ...
            if ((adcmv[0] < (CAP_EMPTY_LEVEL + 2)) && (adcmv[1] < (CAP_EMPTY_LEVEL + 2)) &&
...
#warning "without common emitter hFE"
      ...
      delay(1000);;
        ...
        if (adc.hp1 > (adc.hp2 + 488)) {
          ...
          lcdData('J');
                ...
                trans.uBE[1] = (unsigned int) (((unsigned long) (ADCconfig.U_AVCC - adc.hp1) * 1000) /
                                               RR680PL); // Id 0.01mA
                trans.b = TristatePin;            // save Pin numbers found for this FET
                trans.c = LowPin;
                trans.e = HighPin;
      ...
      delay(1000);;
                ...
                if (adc.tp2 > 977) {
                    ...
                    if ((adc.lp_otr < 97) && (adc.lp1 > 2000)) {
                        ...
                        for (ii = 0; ii < 11; ii++) {
                            ...
                            while (!(ADC_PIN &
                                     PinMSK));        // Wait, until the MOSFET switches and Drain moves to VCC
        ...
        delay(1000);;
            ...
            if ((adc.hp3 < 1600) && (adc.hp2 > 4400)) {
                ...
                R_DDR = HiPinRL |
                        TriPinRL;    // switch R_L port for TristatePin (Gate) to output (GND) => Triac should be triggered
  ...
  */
    ...
    if ((adc.hp1 > 150) && (adc.hp1 < 4640) && (adc.hp2 < adc.hp1) && (adc.hp1 > (adc.hp3 + (adc.hp3 / 8))) &&
        (adc.hp3 * 16 > adc.hp1)) {
